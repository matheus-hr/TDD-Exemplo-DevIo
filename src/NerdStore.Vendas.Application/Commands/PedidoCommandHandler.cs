...
{
    public class PedidoCommandHandler : IRequestHandler<AdicionarItemPedidoCommand, bool> //Necessario para fazer dele um Handler
    {
        ...
        public async Task<bool> Handle(AdicionarItemPedidoCommand message, CancellationToken cancellationToken)
        {
            ...
            else
            {
                ...
                {
                    _pedidoRepository.AtualizarItem(pedido.PedidoItems.FirstOrDefault(i => i.ProdutoId == pedidoItem.ProdutoId));
                }
                else
                {
